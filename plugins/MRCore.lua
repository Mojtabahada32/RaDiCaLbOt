...
text ="*ʀaɖɨᴄaʟɮօt SєƬƬιηgѕ :*\n\n🔐 `ƓяσUρ` #Lσcк `Ƥяσ Lιѕт :`\n\n*>Lιηк :* "..settings.lock_link.."\n*>Ɛɗιт :* "..settings.lock_edit.."\n*>Uѕєяηαмє :* "..settings.lock_username.."\n*>Ƭαg :* "..settings.lock_tag.."\n*>Mєηтιση :* "..settings.lock_mention.."\n*>Ɯєвραgє :* "..settings.lock_webpage.."\n*>Aяαвιc :* "..settings.lock_arabic.."\n*>ƐηgƖιѕн :* "..settings.lock_english.."\n*>Mαякɗσωη :* "..settings.lock_markdown.."\n*>Ɠιf :* "..mutes.mute_gif.."\n*>Ƭєxт :* "..mutes.mute_text.."\n*>IηƖιηє :* "..mutes.mute_inline.."\n*>Ɠαмє :* "..mutes.mute_game.."\n*>Ƥнσтσ :* "..mutes.mute_photo.."\n*>Ʋιɗєσ :* "..mutes.mute_video.."\n*>Ѕεlғ Ʋιdεσ :* "..mutes.mute_video_self.."\n*>Aυɗισ :* "..mutes.mute_audio.."\n*>Ʋσιcє :* "..mutes.mute_voice.."\n*>Sтιcкєя :* "..mutes.mute_sticker.."\n*>Ƈσηтαcт :* "..mutes.mute_contact.."\n*>Ƒσяωαяɗ :* "..mutes.mute_forward.."\n*>Lσcαтιση :* "..mutes.mute_location.."\n*>Ɗσcυмєηт :* "..mutes.mute_document.."\n*>ƘєуƁσαяɗ :* "..mutes.mute_keyboard.."\n➿➰➿➰➿➰➿➰➿➰\n🔐 `ƓяσUρ` #Lσcк `Lιѕт :`\n\n*>SιƖєηт Ɠρ :* "..mutes.mute_all.."\n*>Lσcк Ƭιмє :* "..mute_all1.."\n*>Lσcк ƬƓѕєяνιcє :* "..mutes.mute_tgservice.."\n*>Lσcк Jσιη :* "..settings.lock_join.."\n*>Lσcк Spam :* "..settings.lock_spam.."\n*>Lσcк ƑƖσσɗ :* "..settings.lock_flood.."\n*>Ƥιη Mєѕѕαgє :* "..settings.lock_pin.."\n➿➰➿➰➿➰➿➰➿➰\n💠 `ƓяσUρ` #OƬнƐя `SєттιηƓѕ :`\n\n*>Ɠяσυρ ƜєƖcσмє :* "..settings.welcome.."\n*>Ɓσтѕ Ƥяσтєcтιση :* "..settings.lock_bots.."\n*>ƑƖσσɗ Sєηѕιтινιту :* `"..NUM_MSG_MAX.."`\n*>ƑƖσσɗ Ƈнєcк Ƭιмє :* `"..TIME_CHECK.."`\n*>Ƈнαяαcтєя Sєηѕιтινιту :* `"..SETCHAR.."`\n*>Ɓσтѕ Ƈσммαηɗѕ :* "..cmdsss.."\n*>Ɛxριяє Ɗαтє :* `"..expire_date.."`\n*>Auto lock :* "..stats1.."\n\n➿➰➿➰➿➰➿➰➿➰\n🌐 `IηfσRмαƬιση :`\n\n*>Ɠяσυρ Ɲαмє :* "..(check_markdown(msg.to.title) or "").."\n*>Ɠяσυρ IƊ :* `"..msg.to.id.."`\n*>Ƴσυя Ɲαмє :* "..(check_markdown(msg.from.first_name) or "No ɳαɱҽ").."\n*>Ƴσυя IƊ :* `"..msg.from.id.."`\n*>Uѕєяηαмє :* @"..check_markdown(msg.from.username or "").."\n\n➿➰➿➰➿➰➿➰➿➰\n*>ƇнαηηєƖ :* "..check_markdown(MaTaDoRch).."\n*>Ƥσωєяєɗ Ɓу :* "..check_markdown(MaTaDoRby).."\n*>Ɠяσυρ Lαηgυαgє :* `Eɴ`"
else
local settings = data[tostring(target)]["settings"]
local mutes = data[tostring(target)]["mutes"] 
text ="*تنظیمـات رادیڪال بوت :*\n\n🔐 `لیست` #قفـل `پیشـرفـته گـروه :`\n\n*┓🔗لیـنڪ :* "..settings.lock_link.."\n*┫📝ویـرایـش :* "..settings.lock_edit.."\n┫*🆔نـام ڪاربـری :* "..settings.lock_username.."\n┫*#️⃣هشـتگ :* "..settings.lock_tag.."\n┫*⚛️فـراخوانـی :* "..settings.lock_mention.."\n┛*🌏 صفحـات وب :* "..settings.lock_webpage.."\n╗*🔡عـربـی :* "..settings.lock_arabic.."\n╣*🔠انگلیـسـی :* "..settings.lock_english.."\n╣*🀄️فـونت :* "..settings.lock_markdown.."\n╣*🎞گیـف :* "..mutes.mute_gif.."\n╣*📖متـن :* "..mutes.mute_text.."\n╣*💠اینـلایـن :* "..mutes.mute_inline.."\n╣*🎮بـازی :* "..mutes.mute_game.."\n╣*🖼عڪـس :* "..mutes.mute_photo.."\n╣*📽فیـلم :* "..mutes.mute_video.."\n╝*📹فیلـم سلـفی  :* "..mutes.mute_video_self.."\n┓*🎼آهنگ :* "..mutes.mute_audio.."\n┫*🎤ویـس :* "..mutes.mute_voice.."\n┫*🎭استیـڪر :* "..mutes.mute_sticker.."\n┫*👤مخـاطـب :* "..mutes.mute_contact.."\n┫*☣️فـوروارد :* "..mutes.mute_forward.."\n┫*🚻مـڪان :* "..mutes.mute_location.."\n┫*🗂فـایل :* "..mutes.mute_document.."\n┛*⌨️ڪیبورد شیشه ای :* "..mutes.mute_keyboard.."\n➿➰➿➰➿➰➿➰➿➰\n🔐 `لـیست` #قفـل هـا `گـروه :`\n\n╗*🔕گـروه سڪوت :* "..mutes.mute_all.."\n╣*⏰قفـل زمان بیصدا :* "..mute_all2.."\n╣*🔁سرویس تلگرام :* "..mutes.mute_tgservice.."\n╣*↩️قفـل ورود :* "..settings.lock_join.."\n╣*☢️قفـل هرزنامه :* "..settings.lock_spam.."\n╣*♒️قفـل رگـباری :* "..settings.lock_flood.."\n╝*🖇سـنجاق پیـام :* "..settings.lock_pin.."\n➿➰➿➰➿➰➿➰➿➰\n💠 `لیـست` #دیـگر `تنظیمـات گـروه :`\n\n┓*🤝خـوش آمـدگـویـی :* "..settings.welcome.."\n┫*🤖قفـل ربـات Api  :* "..settings.lock_bots.."\n┫*🔀حداڪثر پیـام رگـباری :* `"..NUM_MSG_MAX.."`\n┫*🕒زمـان بـررسی رگـباری :* `"..TIME_CHECK.."`\n┫*🔣حداڪثر ڪارکتر مـجاز :* `"..SETCHAR.."`\n┫*🛃دستـورات ربـات :* "..cmdsss.."\n┫*🗓تاریـخ انقضـا :* `"..expire_date.."`\n┛*🔐قفـل خـودڪار :* "..stats1.."\n\n➿➰➿➰➿➰➿➰➿➰\n🌐 `اطلـــــاعـات گـــــروه :`\n\n╗*💬نـام گـروه :* "..(check_markdown(msg.to.title) or "").."\n╝*🔢آیـدی گـروه :* `"..msg.to.id.."`\n╗*🗣نـام شمـا :* "..(check_markdown(msg.from.first_name) or "No ɳαɱҽ").."\n╣*🔢آیـدی شمـا :* `"..msg.from.id.."`\n╝*🆔 یـوزرنیـم :* @"..check_markdown(msg.from.username or "").."\n\n➿➰➿➰➿➰➿➰➿➰\n*Channel :* "..check_markdown(MaTaDoRch).."\n*SudoBot :* "..check_markdown(MaTaDoRby).."\n*Group Language :* `فـارسـی`"
end
if not lang then
...
if ((matches[1]:lower() == "" ) or (matches[1] == 'تنظیمات کلی' )) and is_mod(msg) then
...
return "*آنلاینم 🤖✅* `>["..(msg.from.username or ':|').."]<`" 
   ...
   tdcli.sendAnimation(msg.to.id, msg.id, 0, 0, nil, "./data/ping.mp4", nil,nil,"🕵🏻انلاینم پیام های گروه برسی میشن..!" )
end 
if matches[1]:lower() == "nerkh" or matches[1] == 'نرخ' then
text = [[
💸لیست قیمت های ربات ضد اسپم :💸
➖➖➖➖➖➖➖➖➖➖
1️⃣ ماه برای گروه شما 10000 تومن💷
➖➖➖➖➖➖➖➖➖➖
2️⃣ ماه برای گروه شما 18000 تومن💶
➖➖➖➖➖➖➖➖➖➖
3️⃣ ماه برای گروه شما 25000 تومن💵
