...
chats = {}
plugins = {}
MaTaDoR_sudo = 473550877,0000000,0000000 -- ایدی سودوی اصلی را قرار دهید
GpsidSudo = 473550877
...
function create_config( )
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {473550877,462116542,0000000,0000000}, -- در اینجا آیدی ربات api و cli  و سودو ها را وارد کنید
    admins = {},
    disabled_channels = {},
